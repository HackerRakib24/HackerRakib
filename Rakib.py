...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mHacker Rakib
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801746951657
\x1b[93;1m Facebook       \x1b[92;1m=>      \x1b[93;1m RAKIB
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("xdg-open https://www.facebook.com/Dj.Rakib.420")
		exit()
	else:
		os.system("https://www.facebook.com/Dj.Rakib.420")
		exit()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [RAKIB-OK] %s|%s        '%(b,idf,pw))
